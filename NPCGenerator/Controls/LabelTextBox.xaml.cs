...
namespace NPCGenerator.Controls
{
    ...
    public partial class LabelTextBox
    {
        ...
        public static readonly DependencyProperty TextBoxProperty =
             DependencyProperty.Register( "TextBox", typeof( string ), typeof( LabelTextBox ), new FrameworkPropertyMetadata( string.Empty, OnTextBoxPropertyChanged ) );
        ...
        public static readonly DependencyProperty IsReadOnlyProperty =
            DependencyProperty.Register( "IsReadOnly", typeof( bool ),
                typeof( LabelTextBox ), new PropertyMetadata( false, OnIsReadOnlyPropertyChanged ) );
        ...
        public static readonly DependencyProperty TextHorizontalAlignmentProperty =
            DependencyProperty.Register( "TextHorizontalAlignment", typeof( HorizontalAlignment ), typeof( LabelTextBox ), new PropertyMetadata( HorizontalAlignment.Left, OnTextHorizontalAlignmentPropertyChanged ) );
        ...
        public static readonly DependencyProperty TextVerticalAlignmentProperty =
            DependencyProperty.Register( "TextVerticalAlignment", typeof( VerticalAlignment ), typeof( LabelTextBox ), new PropertyMetadata( VerticalAlignment.Top, OnTextVerticalAlignmentPropertyChanged ) );
